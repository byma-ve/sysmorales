...
function CTransporte({
  ...
  useEffect(() => {
    setFormValues({
      ...
      num_manifiesto_liquidacion_transportista:
        selectedData?.id_num_manifiesto_despacho || "",
      num_documento_liquidacion_transportista:
        selectedData?.numero_documento || "",
      tipo_documento_liquidacion_transportista:
        selectedData?.tipo_documento || "",
      estado_documento_liquidacion_transportista:
        selectedData?.estado_documento || "",
    });
  ...
  const handleSelectChange = (selectedOption) => {
    ...
    setFormValues((prevValues) => ({
      ...prevValues,
      tipo_documento_liquidacion_transportista: value,
    }));
  };
  ...
  const handleSubmit = async (e) => {
    ...
    formDataWithImage.append(
      "nombre_transportista",
      formValues.nombre_transportista
    );
    formDataWithImage.append(
      "num_manifiesto_liquidacion_transportista",
      formValues.num_manifiesto_liquidacion_transportista
    );
    formDataWithImage.append(
      "num_documento_liquidacion_transportista",
      formValues.num_documento_liquidacion_transportista
    );
    formDataWithImage.append(
      "tipo_documento_liquidacion_transportista",
      formValues.tipo_documento_liquidacion_transportista
    );
    formDataWithImage.append(
      "estado_documento_liquidacion_transportista",
      formValues.estado_documento_liquidacion_transportista
    );
                          ...
                          <Select
                            ...
                            value={
                              formValues.tipo_documento_liquidacion_transportista
                                ? optionsDOC.find(
                                    (option) =>
                                      option.value === formValues.tipo_documento_liquidacion_transportista
                                  )
                                : null
                            }
