  ...
  async function descargarTabla() {
    try {
      ...
      if (tarifaSeleccionada === "Courier") {
        apiUrl = `https://sysdemo.byma-ve.com/BackendApiRest/Tarifarios/Agente/exportarCourrier.php?id_agente=${encodeURIComponent(
          clienteSeleccionado?.id
        )}`;
      }
      if (tarifaSeleccionada === "Aereo") {
        apiUrl = `https://sysdemo.byma-ve.com/BackendApiRest/Tarifarios/Agente/exportarAereo.php?id_agente=${encodeURIComponent(
          clienteSeleccionado?.id
        )}`;
      }
