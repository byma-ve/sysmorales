  ...
  async function descargarTabla() {
    try {
      ...
      if (tarifaSeleccionada === "Courier") {
        apiUrl = `https://sistema.transportesmorales-logistik.com/BackendApiRest/Tarifarios/Agente/exportarCourrier.php?id_agente=${encodeURIComponent(
          clienteSeleccionado?.id
        )}`;
      }
      if (tarifaSeleccionada === "Aereo") {
        apiUrl = `https://sistema.transportesmorales-logistik.com/BackendApiRest/Tarifarios/Agente/exportarAereo.php?id_agente=${encodeURIComponent(
          clienteSeleccionado?.id
        )}`;
      }
