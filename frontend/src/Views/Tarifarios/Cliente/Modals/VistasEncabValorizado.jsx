...
import { EncabTablaValorizado } from "../Data/EncabTablaValorizado";

export const EncabezadosValorizado = ({
  modalVisible3,
  setModalVisible3,
  onGuardarColumnas,
}) => {
  const [columnasSeleccionadas, setColumnasSeleccionadas] = useState(() => {
    const initialState = {};
    EncabTablaValorizado.forEach((header) => {
    ...
    <>
      <div
        className={`side-panel-container ${
          modalVisible3 ? "visible" : "invisible"
      ...
      >
        <div
          className={`side-panel-cont-container ${
            modalVisible3 ? "translate-y-0" : "translate-y-[600%]"
              ...
              <div className="side-panel bg-white  h-full w-auto m-0 rounded-md">
                <div className="side-cont-titulo mb-6 text-[25px] px-5 py-2 rounded-t-md bg-blue-400 w-full font-semibold text-white">
                  <div className="side-titulo flex w-full">
                    <h1 className="side-txt mr-4 whitespace-nowrap w-full">
                ...
                <div className="section-crm pb-6 px-6">
                  <div className=" card-container">
                    <form className="grid grid-cols-[1fr,1fr,1fr] justify-between px-6 ">
                      {EncabTablaValorizado.map((header, index) => (
