...
import { EncabTablaCarga } from "../Data/EncabTablaCarga";

export const EncabezadosCarga = ({
  modalVisible4,
  setModalVisible4,
  onGuardarColumnas,
}) => {
 ...
 const [columnasSeleccionadas, setColumnasSeleccionadas] = useState(() => {
    const initialState = {};
    EncabTablaCarga.forEach((header) => {
    ...
    <>
      <div
        className={`side-panel-container ${
          modalVisible4 ? "visible" : "invisible"
      ...
      >
        <div
          className={`side-panel-cont-container ${
            modalVisible4 ? "translate-y-0" : "translate-y-[600%]"
                ...
                <div className="section-crm pb-6 px-6">
                  <div className=" card-container">
                    <form className="grid grid-cols-[1fr,1fr,1fr] justify-between px-6 ">
                      {EncabTablaCarga.map((header, index) => (
