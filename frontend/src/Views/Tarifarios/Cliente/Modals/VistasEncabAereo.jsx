...
import { EncabTablaAereo } from "../Data/EncabTablaAereo";

export const EncabezadosAereo = ({
  modalVisible2,
  setModalVisible2,
  onGuardarColumnas,
}) => {
  ...
  const [columnasSeleccionadas, setColumnasSeleccionadas] = useState(() => {
    const initialState = {};
    EncabTablaAereo.forEach((header) => {
    ...
    <>
      <div
        className={`side-panel-container ${
          modalVisible2 ? "visible" : "invisible"
      ...
      >
        <div
          className={`side-panel-cont-container ${
            modalVisible2 ? "translate-y-0" : "translate-y-[600%]"
                ...
                <div className="section-crm pb-6 px-6">
                  <div className=" card-container">
                    <form className="grid grid-cols-[1fr,1fr,1fr] justify-between px-6 ">
                      {EncabTablaAereo.map((header, index) => (
