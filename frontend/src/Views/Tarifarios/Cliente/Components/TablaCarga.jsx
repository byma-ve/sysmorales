                ...
                courriersActuales.map((courrier, index) => (
                  ...
                  >
                    ...
                    <td className="px-10 py-4 ">
                      {courrier.kg_maximo_tarifario_cliente_carga}
                    </td>
                    <td className="px-10 py-4 ">
                      {courrier.kg_base_adicional_tarifario_cliente_carga}
                    </td>
                    <td className="px-10 py-4 ">
                      {courrier.paquete_tarifario_cliente_carga}
                    </td>
                    <td className="px-10 py-4 ">
                      {courrier.tmin_tarifario_cliente_carga}
                    </td>
                    <td className="px-10 py-4 ">
                      {courrier.tmax_tarifario_cliente_carga}
                    </td>
                  </tr>
                ))}
            </tbody>
