                ...
                courriersActuales.map((courrier, index) => (
                  ...
                  >
                    ...
                    <td className="px-10 py-4 ">
                      {courrier.kg_tarifario_cliente_courrier}
                    </td>
                    <td className="px-10 py-4 ">
                      {courrier.kg_adicional_tarifario_cliente_courrier}
                    </td>
                    <td className="px-10 py-4 ">
                      {courrier.tmin_tarifario_cliente_courrier}
                    </td>
                    <td className="px-10 py-4 ">
                      {courrier.tmax_tarifario_cliente_courrier}
                    </td>
                  </tr>
                ))}
            </tbody>
