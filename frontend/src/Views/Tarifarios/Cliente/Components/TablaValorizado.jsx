                ...
                courriersActuales.map((courrier, index) => (
                  ...
                  >
                    ...
                    <td className="px-10 py-4 ">
                      {courrier.producto_tarifario_cliente_valorizado}
                    </td>
                    <td className="px-10 py-4 ">
                      {courrier.costo_producto_tarifario_cliente_valorizado}
                    </td>
                    <td className="px-10 py-4 ">
                      {courrier.tmin_tarifario_cliente_valorizado}
                    </td>
                    <td className="px-10 py-4 ">
                      {courrier.tmax_tarifario_cliente_valorizado}
                    </td>
                  </tr>
                ))}
            </tbody>
