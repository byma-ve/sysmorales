...
const BuscadorServicio = ({ isOpen, onClose, onSelectIgv }) => {
                ...
                <table className="w-full">
                  <thead>
                    <tr className="text-left text-gray-600">
                      <th className="py-2">Areas del Cliente</th>
                      <th className="py-2">N° O. Servicio</th>
                      <th className="py-2">F. de Emisión</th>
                      <th className="py-2">Cantidad Guias</th>
                    </tr>
                  </thead>
