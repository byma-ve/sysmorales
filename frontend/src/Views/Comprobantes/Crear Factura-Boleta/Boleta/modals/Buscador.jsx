        ...
        default:
          return (
            ...
            >
              ...
              <td className="py-2">
                {item.puntoLlegada || item.conductor || ""}
              </td>
            </tr>
          );
      }
            ...
            <div className="p-6 text-sm">
              <div className="bg-white p-4 rounded-lg shadow-md">
                ...
                <div className="flex justify-start mt-4 space-x-2">
                  ...
                  <button className="text-blue-500 px-3 py-1 rounded hover:bg-gray-100">
                    2
                  </button>
                  <button className="text-blue-500 px-3 py-1 rounded hover:bg-gray-100">
                    3
          ...
          <div className="p-6 text-sm">
            <div className="bg-white p-4 rounded-lg shadow-md">
              ...
              <div className="flex items-center space-x-4 mb-4">
                ...
                <button className="bg-gradient-to-t   from-blue-400 via-blue-500 to-blue-500 hover:bg-gradient-to-br  text-white px-4 py-1 rounded ">
                  Buscar
                </button>
              </div>
              {isInitialLoading ? (
