    ...
    <div className="mt-6 border border-gray-400 p-4 rounded-xl">
      <div className="w-full border-b-2 pb-10">
        <table className="w-full bg-white border-collapse">
          <thead className="font-medium text-sm text-gray-500">
            <tr>
              ...
              <th className="px-4 py-2 align-top w-1/12 text-start">Código</th>
              ...
              <th className="px-4 py-2 align-top w-1/12 text-center whitespace-nowrap">
                <h1>Cod. Subp nacional</h1>
              </th>
              <th className="px-4 py-2 align-top w-1/12 text-center whitespace-nowrap">
                <h1>Bien normalizado</h1>
              </th>
            ...
            {filas.map((fila) => (
              <tr key={fila.id} className="items-center">
                ...
                <td className="px-4 py-1">
                  <input
                    type="text"
                    value={fila.precioUnitario2}
                    onChange={(e) =>
                      actualizarFila(fila.id, "precioUnitario2", e.target.value)
                    }
                    className="w-full px-2 bg-gray-200 rounded-sm outline-none focus:ring-1 focus:ring-blue-500/80"
                  />
                </td>
