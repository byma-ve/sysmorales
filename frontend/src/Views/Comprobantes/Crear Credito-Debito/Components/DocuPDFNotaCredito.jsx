...
const DocuPDFNotaCredito = ({ pilares, onClose, color }) => {
  return (
    <Document
      author="Danfer"
            ...
            >
              ...
              >
                <View style={{ flex: 1, flexDirection: "row" }}>
                  ...
                  >
                    <Text style={{ textTransform: "uppercase" }}>Factura</Text>
                  </View>
                </View>
              </View>
              {/* Fila */}
              ...
              >
                <View style={{ flex: 1, flexDirection: "row" }}>
                  ...
                  >
                    <Text style={{ textTransform: "uppercase" }}>
                      FORMA DE PAGO DICE CONTADO Y DEBE SER CREDITO
                    </Text>
                  </View>
                </View>
              </View>
          ...
          >
            ...
            {pilares.map((el, index) => (
              ...
              >
                ...
                >
                  <Text>
                    Servicio de Transporte Terrestre de carga de Lima a
                    Provincias, ruta sur
                  </Text>
                </View>
                <View
                ...
                >
                  <Text style={{ textAlign: "right" }}>9224.61</Text>
                </View>
                <View
                  style={{
                    width: "10%",
...
export default DocuPDFNotaCredito;
