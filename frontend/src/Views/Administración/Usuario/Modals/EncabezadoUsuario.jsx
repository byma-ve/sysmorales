    ...
    <>
      ...
      >
        <div
          ...
          } w-[550px] block absolute transition-transform duration-500`}
        >
          <div className="side-panel-content-container p-4 ">
            <div className="side-panel-iframe h-full">
              <div className="side-panel bg-white  h-full w-auto m-0 rounded-md">
                {/* <div className="side-panel bg-slate-100 p-8 h-full w-auto m-0 rounded-md"> */}
...
export default VistasEncabezado;
