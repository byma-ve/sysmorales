...
function EncabezadosRecojo({
  ...
  const [columnasSeleccionadas, setColumnasSeleccionadas] = useState(() => {
    const initialState = {};
    EncabListaRecojo.forEach((header) => {
    ...
    <>
      ...
      >
        <div
          ...
          } w-[740px] block absolute transition-transform duration-500`}
        >
              ...
              <div className="side-panel bg-white  h-full  w-auto m-0 rounded-md">
                ...
                <div className="section-crm pb-6 px-6">
                  <div className=" card-container">
                    <div className="grid grid-cols-[1fr,1fr,1fr] justify-between px-3">
                      {EncabListaRecojo.map((header, index) => (
...
export default EncabezadosRecojo;
