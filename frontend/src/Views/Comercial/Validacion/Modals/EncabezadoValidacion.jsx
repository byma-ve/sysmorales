...
function EncabezadoValidacion({
  ...
  const [columnasSeleccionadas, setColumnasSeleccionadas] = useState(() => {
    const initialState = {};
    EncabValidacion.forEach((header) => {
            ...
            <div className="side-panel-iframe h-full">
              <div className="side-panel bg-white  h-full w-auto m-0 rounded-md">
                <div className="side-cont-titulo mb-6 text-[25px] px-5 py-2 rounded-t-md bg-blue-400 w-full font-semibold text-white">
                  <div className="side-titulo w-full flex">
                    <h1 className="side-txt side-txt mr-4 w-full">
                ...
                <div className="section-crm pb-6 px-6">
                  <div className=" card-container">
                    <div className="grid grid-cols-[1fr,1fr,1fr] justify-between ">
                      {EncabValidacion.map((header, index) => (
...
export default EncabezadoValidacion;
